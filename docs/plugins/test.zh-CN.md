...
- [@rodolfosv1/test](https://www.npmjs.com/package/@rodolfosv1/test)，测试脚本，内置 `jest` 测试框架
...
对依赖 `umi` 的部分，可以通过从 umi 中创建一个 `Service` 对象。(`@rodolfosv1/core` 的 `Service` 不内置插件)
