// @ts-ignore
import { mergeConfig } from '@rodolfosv1/utils';
...
export default (context: any, opts: IOpts = {}) => {
  ...
  return {
    ...
    plugins: [
      ...
      opts.autoCSSModules && [
        require.resolve('@rodolfosv1/babel-plugin-auto-css-modules'),
      ],
      opts.svgr && [
      ...
      ...(opts.import
        ...
        : []),
      opts.lockCoreJS3 && [
        require.resolve('@rodolfosv1/babel-plugin-lock-core-js-3'),
        opts.lockCoreJS3,
      ],
    ].filter(Boolean),
  };
